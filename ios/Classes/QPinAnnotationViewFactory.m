...
@implementation QPinAnnotationViewFactory {
}
...
- (NSObject <FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id _Nullable)args {
  return [[QPinAnnotationViewPlatformView alloc] initWithViewId:viewId frame: frame registrar:_registrar arguments: args];
}

@end

@implementation QPinAnnotationViewPlatformView {
  int64_t _viewId;
  CGRect _frame;
  NSDictionary<NSString *, Handler>* _handlerMap;
  QPinAnnotationView* _view;
  id _args;
}
...
- (UIView *)view {
  ...
  if (_view == nil) {
    ...
    _view = [[QPinAnnotationView alloc] initWithFrame:_frame];
  ...
  FlutterMethodChannel *channel = [FlutterMethodChannel
        methodChannelWithName:@"me.yohom/tmap_map_fluttify/QPinAnnotationView"
