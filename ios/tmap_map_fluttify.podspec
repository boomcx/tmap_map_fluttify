...
#
Pod::Spec.new do |s|
  s.name             = 'tmap_map_fluttify'
  s.version          = '0.0.1'
  s.summary          = 'An `Tencent Map` Map Component, Powered By `Fluttify` Compiler, A Dart Bindings Generator For Native SDK.'
  s.description      = <<-DESC
A new flutter plugin project.
  ...
  # sdk dependency
  s.dependency 'TencentMap-SDK', '4.3.3'
  ...
  # s.resource_bundles = {
  #   'tmap_map_fluttify' => ['Vendors/*.framework/*.bundle']
  # }
end
