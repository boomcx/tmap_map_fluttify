...
typedef QMapViewCreatedCallback = void Function(QMapView controller);
typedef _OnUiKitViewDispose = Future<void> Function();

class QMapView_iOS extends StatefulWidget {
  const QMapView_iOS({
    Key key,
    this.onViewCreated,
    this.onDispose,
  ...
  final QMapViewCreatedCallback onViewCreated;
  final _OnUiKitViewDispose onDispose;
  final Map<String, dynamic> params;
  final Set<Factory<OneSequenceGestureRecognizer>> gestureRecognizers;

  @override
  _QMapView_iOSState createState() => _QMapView_iOSState();
}

class _QMapView_iOSState extends State<QMapView_iOS> {
  QMapView _controller;
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = QMapView()..refId = refId;
