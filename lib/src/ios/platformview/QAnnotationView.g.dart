...
typedef QAnnotationViewCreatedCallback = void Function(QAnnotationView controller);
typedef _OnUiKitViewDispose = Future<void> Function();

class QAnnotationView_iOS extends StatefulWidget {
  const QAnnotationView_iOS({
    Key key,
    this.onViewCreated,
    this.onDispose,
  ...
  final QAnnotationViewCreatedCallback onViewCreated;
  final _OnUiKitViewDispose onDispose;
  final Map<String, dynamic> params;
  final Set<Factory<OneSequenceGestureRecognizer>> gestureRecognizers;

  @override
  _QAnnotationView_iOSState createState() => _QAnnotationView_iOSState();
}

class _QAnnotationView_iOSState extends State<QAnnotationView_iOS> {
  QAnnotationView _controller;
  ...
  Widget build(BuildContext context) {
    ...
    return UiKitView(
      viewType: 'me.yohom/QAnnotationView',
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = QAnnotationView()..refId = refId;
