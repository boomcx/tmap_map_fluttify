...
import me.yohom.tmap_map_fluttify.sub_handler.*;
...
public class TmapMapFluttifyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {

    private static List<Map<String, Handler>> handlerMapList;

    // v1 android embedding for compatible
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "me.yohom/tmap_map_fluttify", new StandardMethodCodec(new FluttifyMessageCodec()));

        TmapMapFluttifyPlugin plugin = new TmapMapFluttifyPlugin();
        ...
        platformViewRegistry.registerViewFactory("me.yohom/com.tencent.tencentmap.mapsdk.maps.TextureMapView", new TextureMapViewFactory(messenger, activity));
        platformViewRegistry.registerViewFactory("me.yohom/com.tencent.tencentmap.mapsdk.maps.MapView", new MapViewFactory(messenger, activity));
    }
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "TmapMapFluttifyPlugin::onAttachedToEngine@" + binding);
        }

        final MethodChannel channel = new MethodChannel(binding.getBinaryMessenger(), "me.yohom/tmap_map_fluttify", new StandardMethodCodec(new FluttifyMessageCodec()));
    ...
    public void onDetachedFromEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "TmapMapFluttifyPlugin::onDetachedFromEngine@" + binding);
        }
    }
    ...
    public void onAttachedToActivity(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "TmapMapFluttifyPlugin::onAttachedToActivity@" + binding);
        }
    ...
    public void onReattachedToActivityForConfigChanges(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "TmapMapFluttifyPlugin::onReattachedToActivityForConfigChanges@" + binding);
        }
    }
